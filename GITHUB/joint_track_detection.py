...
class Joint:
	...
	smile_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_smile.xml')
	fist_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/hand.xml')
	face_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_frontalface_alt2.xml')
	face_glasses_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_eye_tree_eyeglasses.xml')
	eye_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_eye.xml')
	upper_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_upperbody.xml')
	lower_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_lowerbody.xml')
	full_cascade = cv2.CascadeClassifier('C:/Users/HP/AppData/Local/Programs/Python/Python37/Lib/site-packages/cv2/data/haarcascade_fullbody.xml')
	#Stores all the joints that have been created
	totalJointsList = []
	
	def __init__(self, x=0, y=0, colorName='no colorName', type='head',\
	lowerRange = np.array([0,0,0]), upperRange = np.array([255, 255, 255]),\
	track=1, drawTrack = 1, draw=1):
	...
	def circle(self):
		...
		if len(jointTrail) == self.trailLength and self.still() == False:
			...
			for point in jointTrail:
				vector = [point[0]-center[0], point[1]-center[1]]
				magnitude = Joint.mag(vector)
				if abs(ave_radius) > Joint.circleStrayTollerance:
					drew_circle = False
...
#processing
	...
	#display	
	cv2.imshow('Joint.img', Joint.hsv)
	cv2.imshow('Joint.img1', Joint.img)
